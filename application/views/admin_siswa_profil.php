          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <textarea name="alamat" class="form-control" id="inputAlamat" required="" readonly><?php echo $row->siswa_alamat?></textarea>
                </div>
                <div class="form-group">
                ...
                <a href="<?php echo base_url() ?>admin/form-edit-data-siswa/<?php echo $row->siswa_id ?>" class="btn btn-primary edit">Edit</a>
            </div>
            <!-- /.card-body -->
          </div>
          <!-- /.card -->
